...
public class MainLibrary {
		...
		while(true) {
			...
			switch(option) {
			  ...
			  case 2:ml.booksMethod(new JournalPaper());
			        break;
			  case 3:ml.mediaMethod(new Vedio());
			        break;
	...
	public void booksMethod(WrittenItem i) {
		...
		i.setTitle(sc.next());
		System.out.println("The Book Number of copie");
